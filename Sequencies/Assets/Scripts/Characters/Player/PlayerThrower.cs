...
public class PlayerThrower : MonoBehaviour
{
    ...
    private void Throw()
    {
        ...
        // ?? NEU: Prüfen ob überhaupt irgendwas im Inventar ist
        bool anyItem = false;
        ...
        if (!anyItem)
        {
            //InventoryManager.I.OnMessage?.Invoke("Inventar ist leer!");
        ...
        // Falls selektiertes Item 0 hat -> erstes vorhandenes suchen
