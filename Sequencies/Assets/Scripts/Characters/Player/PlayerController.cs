...
public class PlayerController : MonoBehaviour
{
    ...
    [Tooltip("Prefab mit Point Light 2D. Wird beim Klatschen an der Player-Position gespawnt (dauerhaft).")]
    [SerializeField] private GameObject noiseLightPrefab;

    [Tooltip("Wenn true: Clap spawnt dauerhaftes Licht an der Player-Position.")]
    ...
    public void OnClap(InputValue value)
    {
        ...
        // Spawn permanent light at clap position
